...
- `write_tsv()`: tab separated files (so we don't have to specify `sep="\t"`)

- `write_delim()`: files with a user-defined delimiter
...
The homework and instructions can be found within the main directory for the course: `./content/Homework_5.Rmd`
